...
import { PROGRESSION_OVERLAPPING } from '@surf/core/src/renderers/contours/stories/01-basic-shapes';
import { PROGRESSION_EDGE } from '@surf/core/src/renderers/contours/stories/02-advanced-patterns';
import { PROGRESSION_EMPTY } from '@surf/core/src/renderers/contours/stories/03-edge-cases';
// Note: 04-blur-effect has no progressions, only strip re-exports

defineStoryVisualTests('renderers/contours', [
