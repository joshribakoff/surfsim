...
import { FIELD_HEIGHT, FIELD_WIDTH } from '../model/02-energy/index.js';
...
interface FoamLayer {
  ...
  width: number;
  height: number;
  lastFrame?: Float32Array;
}

function createLayer(width = FOAM_GRID_WIDTH, height = FOAM_GRID_HEIGHT): FoamLayer {
  return {
 ...
 */
export function updateFoamLayer(
  foamGrid,
  energyTransferGrid,
  dt,
